...
HASHES = {
    "test_if1.compute_shader": ("e580648acc6e6d93", "f0a88eba98d266af"),
    "test_if2.compute_shader": ("b5c96a1479de4f42", "f975198b91a9a68b"),
    "test_if3.compute_shader": ("b550d1e4e0696d67", "9b5e4bbaa114b387"),
    "test_if4.compute_shader": ("415d4b87aaf3bd22", "d115ae8eb670d3a2"),
    "test_if5.compute_shader": ("c541d7e5d2a31ae4", "3113f16829da3ce7"),
    "test_ternary1.compute_shader": ("71489b4284d415d0", "b5b554eb8d983baa"),
    "test_ternary2.compute_shader": ("4b3dd69ab5db7735", "39648d87b0a775dc"),
    "test_ternary3.compute_shader": ("1f283449fc009a18", "70c7665d9d5e5e86"),
    "test_andor2.compute_shader": ("680170a3a773c54f", "0013bd7ba12aec02"),
    "test_andor3.compute_shader": ("4a878dce1270af67", "ad3abf1ec3f684a8"),
    "test_andor4.compute_shader": ("78cc57a4cbd34954", "b034c33fae2d658f"),
    "test_andor5.compute_shader": ("dce7ebfbad0c2bf8", "004bfe0c377dd5cb"),
    "test_loop0.compute_shader": ("9d5afc0570dfa6d5", "9ad5dc51d89582ec"),
    "test_loop0b.compute_shader": ("d218aa87e64fc8a7", "c5b498426404ab1b"),
    "test_loop1.compute_shader": ("14612e882f6f9834", "fd9105764be01457"),
    "test_loop2.compute_shader": ("93ba6d1251eb823d", "64ba0cdd0a8094c8"),
    "test_loop3.compute_shader": ("2d849f9d772d861f", "f7b14d07277bd378"),
    "test_loop4.compute_shader": ("3151fa7a52980b9a", "e3b9f0cabf481ea5"),
    "test_loop5.compute_shader": ("37aefa906f824631", "c7d675c4365cfba5"),
    "test_loop6.compute_shader": ("8d20de4d3f4b5b33", "b86c4d65320153f0"),
    "test_loop7.compute_shader": ("d6bd715f582db309", "62682d6a6e990258"),
    "test_loop8.compute_shader": ("0b0b746d9d5fae20", "e62e3d8cc77d476a"),
    "test_while1.compute_shader": ("7b7aaa3164eab8c5", "0a78027b51a94e12"),
    "test_while2.compute_shader": ("94be5b6299da9855", "7340c579fda1bff5"),
    "test_while3.compute_shader": ("f3f0f7099a9edf9b", "3b2465c979e0252e"),
    "test_while4.compute_shader": ("c555169a4649736f", "ab12994267392c7d"),
    "test_while5.compute_shader": ("5f4ce5e00ffe6fb4", "cbcc96bcc10adaf3"),
    "test_while6.compute_shader": ("bf0b39432c31e8a5", "ecfb43c1b4e781dc"),
    "test_discard.fragment_shader": ("bbdaa8848a180860", "6d3182b0b5189d45"),
    "test_long_bytecode.compute_shader": ("0126f7716c3d09aa", "563d949bf73af48d"),
}
